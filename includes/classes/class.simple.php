<?php
	...
	class WMAC_ConfigComments extends Wbcr_FactoryClearfy000_Configurate {
	    ...
	    */
		...
		{
			return WMAC_PLUGIN_DIR . '/includes/comments-template.php';
		}
		...
		public function assetsUrlSpanScripts()
		{
			...
			wp_enqueue_style('wbcr-comments-plus-url-span', WMAC_PLUGIN_URL . '/assets/css/url-span.css', array(), $this->plugin->getPluginVersion());
			wp_enqueue_script('wbcr-comments-plus-url-span', WMAC_PLUGIN_URL . '/assets/js/url-span.js', array('jquery'), $this->plugin->getPluginVersion(), true);
		}
	}